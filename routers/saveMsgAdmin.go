...
// SaveMsgAdmin se encarga de guardar la nota en la base de datos
func SaveMsgAdmin(w http.ResponseWriter, r *http.Request) {
	...
	_, status, errInsert := db.MsgAdmin(register)
